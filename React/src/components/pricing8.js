          ...
          <div className="pricing8-container">
            <div className="pricing8-column thq-card">
              ...
              <a
                ...
                className="pricing8-button04 thq-button-animated thq-button-outline"
              >
            ...
            <div className="pricing8-column1 thq-card">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="pricing8-button05 thq-button-animated thq-button-filled"
              >
            ...
            <div className="pricing8-column2 thq-card">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="pricing8-button06 thq-button-animated thq-button-filled"
              >
          ...
          <div className="pricing8-container1">
            <div className="pricing8-column3 thq-card">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="pricing8-button07 thq-button-animated thq-button-outline"
              >
            ...
            <div className="pricing8-column4 thq-card">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="pricing8-button08 thq-button-animated thq-button-filled"
              >
            ...
            <div className="pricing8-column5 thq-card">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="pricing8-button09 thq-button-animated thq-button-filled"
              >
...
Pricing8.defaultProps = {
  ...
  plan2Feature3: 'Networking opportunities with successful entrepreneurs',
  plan3Yearly1: 'or $89 monthly',
  plan2Price1: '$499/year',
  plan2Feature31: 'Feature text goes here',
  plan2Feature21: 'Feature text goes here',
  plan21: 'Premium plan',
  plan1Feature2: 'Access to exclusive real estate case studies',
  plan2Feature41: 'Feature text goes here',
  heading1: 'Why choose Amit World Academy',
  plan3Price: '$89',
  plan2: 'Premium plan',
  plan2Yearly: '$499',
  plan2Feature1: 'Learn business fundamentals from industry experts',
  plan3Yearly: '$899',
  plan2Feature2: 'Practical exercises to apply business concepts',
  plan2Action1: 'Enroll Now',
  plan1Feature1: 'Basic Real Estate Courses',
  ...
  plan3Feature2: 'Hands-on experience in trading digital assets',
  plan1: 'Basic plan',
  plan2Feature4: 'Feature text goes here',
  plan1Feature21: 'Feature text goes here',
  plan2Price: '$49',
  content2:
    'Expertise in every fields, Tailored Solutions to meet your requirement, Commitment to help you succeed & improve, and Comprehensive Suppo',
  plan3Feature31: 'Feature text goes here',
  plan3Feature21: 'Feature text goes here',
  plan1Feature11: 'Feature text goes here',
  plan3Feature1: 'Understanding cryptocurrency and blockchain technology',
  plan1Action: 'Enroll Now',
  content1: 'Pricing plans',
  plan3Feature3: 'Insights into NFTs and digital art investments',
  plan11: 'Basic plan',
  plan1Feature3: 'Personalized feedback on real estate investment strategies',
  plan31: 'Ultimate plan',
  plan1Price: '$29',
  plan3: 'Ultimate plan',
  plan3Price1: '$899/year',
  plan3Feature4: 'Feature text goes here',
  plan1Price1: '$299/year',
